...
| 文档 | 说明 |
|------|------|
| [架构设计](../01-架构设计/架构概述.md) | 系统架构与核心设计 |
| [MCP 集成方案](../01-架构设计/mcp集成方案.md) | MCP 协议集成详细方案 |
| [MCP Server API](../03-API文档/mcp服务器接口.md) | MCP Server 接口文档 |
| [MCP Client API](../03-API文档/mcp客户端接口.md) | MCP Client 接口文档 |
| [测试指南](../05-测试文档/测试指南.md) | 测试规范与指南 |
