  ...
  - id: prompt_context
    capabilities:
      ...
      - id: constrained_schema
        ...
        derive_rule: { type: code_grep, pattern: 'response_format', path_glob: 'backend/app/services/llm_*.py' }
      - id: skills_bundle
        name_cn: "Skills bundle (17-component)"
        name_en: "Skills bundle"
        derive_rule: { type: file_exists, path: 'backend/app/services/skills/registry.py' }
      - id: per_task_registry
        name_cn: "Per-task plan registry"
        name_en: "Per-task plan registry"
        derive_rule: { type: code_grep, pattern: 'plan_registry', path_glob: 'backend/app/services/skills/**' }
  ...
  - id: tools_function
    capabilities:
      - id: tool_registry
        ...
        derive_rule: { type: file_exists, path: 'backend/app/services/tool_registry.py' }
      - id: schema_validated_io
        name_cn: "Schema-validated tool I/O"
        name_en: "Schema-validated I/O"
        derive_rule: { type: code_grep, pattern: 'BaseModel.*Tool', path_glob: 'backend/app/tools/base.py' }
      - id: di_mock_real
      ...
      - id: financial_tools
        ...
        derive_rule: { type: code_grep, pattern: 'def get_', path_glob: 'backend/app/tools/get_*.py' }
      - id: mcp_bridge
        name_cn: "MCP 协议适配"
        name_en: "MCP bridge"
        derive_rule: { type: manual }
  ...
  - id: orchestration
    capabilities:
      ...
      - id: send_subgraph
        ...
        derive_rule: { type: code_grep, pattern: 'Send\(', path_glob: 'backend/app/agents/**' }
      - id: critic_7_stage
        name_cn: "7 阶段 Critic"
      ...
      - id: sse_streaming
        ...
        derive_rule: { type: code_grep, pattern: 'EventSource|StreamingResponse', path_glob: 'backend/app/api/**' }
      - id: sqlite_saver
        name_cn: "SqliteSaver checkpoint"
        name_en: "SqliteSaver"
        derive_rule: { type: code_grep, pattern: 'SqliteSaver', path_glob: 'backend/app/agents/**' }
      - id: plan_and_execute
  ...
  - id: guardrails
    capabilities:
      - id: constrained_router
        ...
        derive_rule: { type: file_exists, path: 'backend/app/services/constrained_router.py' }
      - id: pydantic_schema
      ...
      - id: langgraph_retry
        ...
        derive_rule: { type: code_grep, pattern: 'add_edge.*retry|conditional_edges', path_glob: 'backend/app/agents/**' }
      - id: per_step_critic
  ...
  - id: eval_observability
    capabilities:
      ...
      - id: cassette_l2
        ...
        name_en: "L2 Cassette"
        derive_rule: { type: code_grep, pattern: 'use_cassette', path_glob: 'backend/tests/**' }
      - id: test_suite
        name_cn: "289+ pytest"
        name_en: "289+ tests"
  ...
  - id: cost_routing
    capabilities:
      ...
      - id: max_tokens_calibration
        ...
        derive_rule: { type: code_grep, pattern: 'max_tokens', path_glob: 'backend/app/services/llm_*.py' }
      - id: model_caching
