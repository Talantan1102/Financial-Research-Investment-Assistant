...
**当前版本**:v0.8.5(constrained LLM router + 17-component Anthropic Skills bundle + 7th critic plan_correctness + LangGraph self-correcting retry edge)+ Harness Board M3(dev meta-tool — D/B/决策 三 tab + decision_extractor + filter UI + note 持久化)
