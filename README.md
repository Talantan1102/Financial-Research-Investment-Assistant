...
**当前版本**:v0.8.5(constrained LLM router + 17-component Anthropic Skills bundle + 7th critic plan_correctness + LangGraph self-correcting retry edge)+ Harness Board M1(dev meta-tool — `make board` 看 8 维 × 62 capability matrix)
