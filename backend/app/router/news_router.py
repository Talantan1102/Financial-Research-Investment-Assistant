...
async def get_news_list(
    category: str | None = Query(None, description="分类：政策/研报/新闻"),
    industry_id: str | None = Query(None, description="行业ID"),
...
async def get_bidding_list(
    notice_type: str | None = Query(None, description="公告类型：招标/中标"),
...
async def trigger_collection(
    ...
    try:
        ...
        return CollectionResponse(success=False, message=f"采集失败: {str(e)}", errors=[str(e)])
