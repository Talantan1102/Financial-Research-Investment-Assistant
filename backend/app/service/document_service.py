...
class DocumentService:
    ...
    def upload_document(self, dataset_id: str, file_path: str) -> dict[str, Any]:
        ...
        files = {"file": (os.path.basename(file_path), open(file_path, "rb"))}  # noqa: SIM115 — file lifetime tied to requests.post call
    ...
    def retrieve_documents(
        self, question: str, dataset_ids: list[str] = None, document_ids: list[str] = None
    ) -> dict[str, Any]:
        """
