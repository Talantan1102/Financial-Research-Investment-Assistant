...
```"""
    ...
    async def _fix_code(self, code: str, error: str, stdout: str) -> dict | None:
        """调用LLM修复代码"""
    ...
    async def _generate_charts(self, state: ResearchState) -> None:
        ...
        if not chart_sections and state["outline"]:
            ...
            self.logger.info("[CodeWizard] 没有 requires_chart 章节，使用前2个章节生成图表")
    ...
    def _execute_in_sandbox(self, code: str) -> dict[str, Any]:
        ...
        try:
            ...
            self._save_debug_log(
                "sandbox_3_exec_output", f"stdout:\n{stdout_value}\n\nstderr:\n{stderr_value}"
            )
            ...
            return {"success": False, "output": stdout_value, "error": error_msg, "charts": []}
