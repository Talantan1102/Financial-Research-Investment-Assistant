...
from app.services.pricing import (
    ...
    DEEPSEEK_V32_INPUT_CNY_PER_1K,
    DEEPSEEK_V32_OUTPUT_CNY_PER_1K,
...
def test_get_price_legacy_v4_flash() -> None:
...
def test_get_price_v0_default_v3_2() -> None:
    p = get_price("deepseek-v3.2")
    assert p.input_per_1k_cny == DEEPSEEK_V32_INPUT_CNY_PER_1K
    assert p.output_per_1k_cny == DEEPSEEK_V32_OUTPUT_CNY_PER_1K
...
def test_compute_cost_reasoning_tokens_billed_as_output() -> None:
    """Per Plan C Task 0 spike: deepseek family are reasoning models;
